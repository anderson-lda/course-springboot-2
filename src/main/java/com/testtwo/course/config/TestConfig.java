package com.testtwo.course.config;
...
import com.testtwo.course.entities.Payment;
...
import com.testtwo.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"),OrderStatus.PAID, u1); //horario UTC, que é diferente horario local
